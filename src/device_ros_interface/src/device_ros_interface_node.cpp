...
int main(int argc, char** argv) {
    ...
    FlamesensorDriver flamesensor(serial);
    SmokesensorDriver smokesensor(serial);
    LiftInterface lift_interface(nh, lift);
    PlatformInterface platform_interface(nh, platform);

    SmokeSensorInterface smoke_sensor_interface(nh,smokesensor);
    FlameSensorInterface flame_sensor_interface(nh,flamesensor);
    EmergencyStopInterface emergency_stop_interface(nh);
