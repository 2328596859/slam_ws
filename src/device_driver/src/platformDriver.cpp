...
std::vector<uint8_t> PlatformDriver::buildFrame(uint8_t data0,uint8_t data1){
...
void PlatformDriver::platform_up(uint8_t data1) {
    auto frame = buildFrame(0x02, data1); 
    serial_.writeFrame(frame);
}

void PlatformDriver::platform_down(uint8_t data1) {
    auto frame = buildFrame(0x03, data1);
    serial_.writeFrame(frame);
}
void PlatformDriver::platform_right(uint8_t data1) {
    auto frame = buildFrame(0x01, data1); 
    serial_.writeFrame(frame);
}
void PlatformDriver::platform_left(uint8_t data1) {
